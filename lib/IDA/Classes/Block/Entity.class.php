...
class Entity extends \IDA\Classes\Base\Entity
{
    ...
    /**
     * @var \IDA\Classes\Infoblock\Entity
     */
    protected $infoblock;
    ...
    public function hasPropValue($propName)
    {
        return !empty($this->data[$propName]['VALUE']);
    }
    ...
    public final function handleSvg($key)
    {
        if (!$this->hasFile($key)) {
            return '';
        }
    ...
    /**
     * @return \IDA\Classes\Block\Image[]
     */
    ...
    public function sliderLink()
    {
        return boolval($this->data["SLIDER_LINK"]['VALUE']) ? $this->data["SLIDER_LINK"]['VALUE'] : false;
    }
    ...
    {
        return $this->getTimestamp('DATE_ACTIVE_FROM') < time() && $this->getTimestamp('DATE_ACTIVE_TO') > time();
    }
    ...
    {
        return $this->getDate('DATE_ACTIVE_FROM', $format);
    }
    ...
    /**
     * @param $key
     * @return \IDA\Classes\Block\Getter
     */
...
//                'IBLOCK_ID' => $prop['LINK_IBLOCK_ID']
    ...
    /**
     * @return \IDA\Classes\Section\Entity
     */
    public function getParentSection()
    {
        return \IDA\Classes\Section\Getter::instance()->getById($this->iblock_section_id);
    }
    ...
    public function save()
    {
        ...
        $blockFields = \IDA\Classes\Infoblock\Getter::instance()->getById($this->IBLOCK_ID)->getFields();
        $blockProperties = \IDA\Classes\Infoblock\Getter::instance()->getById($this->IBLOCK_ID)->getProperties();
